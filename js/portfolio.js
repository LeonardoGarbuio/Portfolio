...
console.log(
  "%c SYSTEM // DRONE CONNECTED \n%c V_FINAL_ROTATION_FIX \n%c ---------------------------------------- \n%c SE VOCÊ ESTÁ LENDO ISSO, VOCÊ É UM DOS NOSSOS. \n%c QUER CONSTRUIR O FUTURO? ENTRE EM CONTATO.",
  "color: #4ade80; font-weight: bold; font-size: 16px;",
  "color: #a1a1aa; font-size: 12px;",
  "color: #333;",
  "color: #fff; font-weight: bold; font-size: 14px; background: #000; padding: 4px;",
  "color: #3b82f6; font-style: italic; margin-top: 5px;",
);
...
if (container) {
  ...
  renderer.setPixelRatio(Math.min(window.devicePixelRatio, 1.5)); // Optimizado para não travar celulares
  ...
  // Otimização: Pausar 3D quando a aba estiver em segundo plano
  ...
  function animate() {
    ...
    if (!isRendering) return; // Economiza GPU/Bateria quando a aba não está ativa
